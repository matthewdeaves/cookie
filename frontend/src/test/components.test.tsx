...
describe('Search', () => {
  ...
  it('shows search results', async () => {
    vi.mocked(api.recipes.search).mockResolvedValueOnce({
      results: [
        { url: 'https://example.com/recipe1', title: 'Chocolate Cookies', host: 'example.com', image_url: '', description: 'Delicious' },
        { url: 'https://example.com/recipe2', title: 'Sugar Cookies', host: 'example.com', image_url: '', description: 'Sweet' },
      ],
      total: 2,
      page: 1,
      has_more: false,
  ...
  it('displays result count', async () => {
    vi.mocked(api.recipes.search).mockResolvedValueOnce({
      results: [{ url: 'https://example.com/recipe', title: 'Test Recipe', host: 'example.com', image_url: '', description: '' }],
      total: 1,
      page: 1,
      has_more: false,
      sites: { 'example.com': 1 },
  ...
  it('shows load more button when has_more is true', async () => {
    vi.mocked(api.recipes.search).mockResolvedValueOnce({
      results: [{ url: 'https://example.com/recipe', title: 'Recipe', host: 'example.com', image_url: '', description: '' }],
      total: 50,
      page: 1,
      has_more: true,
      sites: {},
