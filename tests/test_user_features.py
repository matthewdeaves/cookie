...
class TestFavoritesAPI:
    ...
    def test_remove_favorite(self, client, profile_a, recipe):
        ...
        assert not RecipeFavorite.objects.filter(profile=profile_a, recipe=recipe).exists()
...
class TestCollectionsAPI:
    ...
    def test_get_collection(self, client, profile_a, recipe):
        ...
        select_profile(client, profile_a)
        collection = RecipeCollection.objects.create(profile=profile_a, name="Desserts")
    ...
    def test_remove_recipe_from_collection(self, client, profile_a, recipe):
        ...
        response = client.delete(f"/api/collections/{collection.id}/recipes/{recipe.id}/")
        assert response.status_code == 204
        assert not RecipeCollectionItem.objects.filter(collection=collection, recipe=recipe).exists()
...
class TestHistoryAPI:
    ...
    def test_record_view_updates_timestamp(self, client, profile_a, recipe):
        ...
        assert RecipeViewHistory.objects.filter(profile=profile_a, recipe=recipe).count() == 1
...
class TestProfileIsolation:
    ...
    def test_collection_access_isolation(self, client, profile_a, profile_b):
        ...
        # Profile A creates a collection
        collection = RecipeCollection.objects.create(profile=profile_a, name="My Collection")
    ...
    def test_same_collection_name_different_profiles(self, client, profile_a, profile_b):
