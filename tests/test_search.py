...
class TestSearchHelpers:
    ...
    def test_looks_like_recipe_url_recipe_path(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://allrecipes.com/recipe/12345/chocolate-chip-cookies/',
            'allrecipes.com'
        ) is True
    ...
    def test_looks_like_recipe_url_recipes_path(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://food52.com/recipes/12345-cookies',
            'food52.com'
        ) is True
    ...
    def test_looks_like_recipe_url_wrong_host(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://different-site.com/recipe/123',
            'allrecipes.com'
        ) is False
    ...
    def test_looks_like_recipe_url_search_page(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://allrecipes.com/search?q=cookies',
            'allrecipes.com'
        ) is False
    ...
    def test_looks_like_recipe_url_category_page(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://allrecipes.com/category/desserts/',
            'allrecipes.com'
        ) is False
    ...
    def test_looks_like_recipe_url_author_page(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://allrecipes.com/author/chef-john/',
            'allrecipes.com'
        ) is False
    ...
    def test_looks_like_recipe_url_long_path(self):
        ...
        assert self.search._looks_like_recipe_url(
            'https://example.com/food/desserts/chocolate-chip-cookies-recipe',
            'example.com'
        ) is True
