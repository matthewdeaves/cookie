...
class TestImageCaching:
    ...
    @patch("apps.recipes.services.image_cache.AsyncSession")
    async def test_fetch_image_non_image_content_type_returns_none(self, mock_session_class, image_cache):
    ...
    @patch("apps.recipes.services.image_cache.AsyncSession")
    async def test_download_and_save_marks_failed_on_error(self, mock_session_class, image_cache, db):
    ...
    @patch("apps.recipes.services.image_cache.AsyncSession")
    async def test_download_and_save_skips_already_cached(self, mock_session_class, image_cache, sample_jpeg_bytes, db):
...
class TestBatchCachedUrlLookup:
    ...
    async def test_get_cached_urls_batch_returns_cached(self, image_cache, sample_jpeg_bytes):
    ...
    async def test_get_cached_urls_batch_excludes_pending(self, image_cache):
    ...
    async def test_get_cached_urls_batch_excludes_failed(self, image_cache):
    ...
    async def test_get_cached_urls_batch_excludes_empty_images(self, image_cache):
